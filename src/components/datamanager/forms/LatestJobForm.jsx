...
const LatestJobForm = ({ form, onChange }) => (
  <div className="space-y-4">
    {[
      ...
      { name: "examDate", label: "Exam / Exam Date", type: "text" },
      { name: "vacancy", label: "Vacancy", type: "text" },
      ...
      { name: "notificationPdf", label: "Notification PDF URL", type: "text" },
      { name: "applyLink", label: "Apply Online URL", type: "text" },
