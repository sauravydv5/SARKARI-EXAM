...
const navItems = [
  ...
  { to: '/ssc-jobs', label: 'SSC Jobs', icon: '🏛️' },
  { to: '/railway-jobs', label: 'Railway Jobs', icon: '🚆' },
  { to: '/bank-jobs', label: 'Bank Jobs', icon: '🏦' },
  { to: '/up-jobs', label: 'UP Jobs', icon: '📍' },
  { to: '/bihar-jobs', label: 'Bihar Jobs', icon: '📌' },
  { to: '/admission', label: 'Admission', icon: '🎓' },
  // { to: '/bihar-special', label: 'Bihar Special', icon: '📍' },
