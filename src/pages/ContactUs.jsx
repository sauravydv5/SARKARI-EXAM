  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      <header className="mb-8 border-b border-slate-200 pb-8 dark:border-slate-700">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600 dark:text-slate-300">Send a clear message about a correction, broken link, missing update, or question about using the website. We are here to help improve official-link clarity, source cross-checks, and page accuracy.</p>
      </header>
